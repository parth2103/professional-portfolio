  ...
  return (
    <div className="relative">
      ...
      <div className="relative z-10">
        ...
        {/* Footer */}
        <footer className="bg-transparent py-12 border-t border-border/50">
            ...
            <div className="flex flex-col items-center gap-4">
              <div className="flex gap-4">
                <a
                  ...
                  className="p-2 rounded-full bg-card/80 backdrop-blur-sm hover:bg-primary transition-colors"
                >
